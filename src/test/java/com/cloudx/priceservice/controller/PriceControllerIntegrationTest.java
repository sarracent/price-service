package com.cloudx.priceservice.controller;
...
class PriceControllerIntegrationTest {
    ...
    void testRequestAt10AMOnDay14() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/prices")
                ...
                .andExpect(jsonPath("$.prices[0].price").value(35.5));
    }
    ...
    void testRequestAt4PMOnDay14() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/prices")
                ...
                .andExpect(jsonPath("$.prices[0].productId").value(35455))
                .andExpect(jsonPath("$.prices[0].brandId").value(1))
                .andExpect(jsonPath("$.prices[0].priceList").value(2))
                .andExpect(jsonPath("$.prices[0].startDate").value("2020-06-14T15:00:00"))
                .andExpect(jsonPath("$.prices[0].endDate").value("2020-06-14T18:30:00"))
                .andExpect(jsonPath("$.prices[0].price").value(25.45))

                .andExpect(jsonPath("$.prices[1].productId").value(35455))
                .andExpect(jsonPath("$.prices[1].brandId").value(1))
                .andExpect(jsonPath("$.prices[1].priceList").value(1))
                .andExpect(jsonPath("$.prices[1].startDate").value("2020-06-14T00:00:00"))
                .andExpect(jsonPath("$.prices[1].endDate").value("2020-12-31T23:59:59"))
                .andExpect(jsonPath("$.prices[1].price").value(35.5));
    }
    ...
    void testRequestAt10AMOnDay15() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/prices")
                ...
                .andExpect(jsonPath("$.prices[0].productId").value(35455))
                .andExpect(jsonPath("$.prices[0].brandId").value(1))
                .andExpect(jsonPath("$.prices[0].priceList").value(3))
                .andExpect(jsonPath("$.prices[0].startDate").value("2020-06-15T00:00:00"))
                .andExpect(jsonPath("$.prices[0].endDate").value("2020-06-15T11:00:00"))
                .andExpect(jsonPath("$.prices[0].price").value(30.5))
    ...
    void testRequestAt9PMOnDay16() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/prices")
                ...
                .andExpect(jsonPath("$.prices[0].productId").value(35455))
                .andExpect(jsonPath("$.prices[0].brandId").value(1))
                .andExpect(jsonPath("$.prices[0].priceList").value(4))
                .andExpect(jsonPath("$.prices[0].startDate").value("2020-06-15T16:00:00"))
                .andExpect(jsonPath("$.prices[0].endDate").value("2020-12-31T23:59:59"))
                .andExpect(jsonPath("$.prices[0].price").value(38.95))
